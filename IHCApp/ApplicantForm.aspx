...
<body class="homepage">
    ...
    <script src="WebAssets/assets/js/jquery.dropotron.min.js"></script>
    <script src="WebAssets/assets/js/skel.min.js"></script>
    ...
    <!-- Nice-assets .js -->
    <script src="WebAssets/assets/nice-WebAssets/assets/js/jquery.js"></script>
	<script src="WebAssets/assets/nice-WebAssets/assets/js/jquery-ui-1.10.4.min.js"></script>
    <script src="WebAssets/assets/nice-WebAssets/assets/js/jquery-1.8.3.min.js"></script>
    <script type="text/javascript" src="WebAssets/assets/nice-WebAssets/assets/js/jquery-ui-1.9.2.custom.min.js"></script>
    <!-- bootstrap -->
    <script src="WebAssets/assets/nice-WebAssets/assets/js/bootstrap.min.js"></script>
    <!-- nice scroll -->
    <script src="WebAssets/assets/nice-WebAssets/assets/js/jquery.scrollTo.min.js"></script>
    <script src="WebAssets/assets/nice-WebAssets/assets/js/jquery.nicescroll.js" type="text/javascript"></script>
    <!-- charts scripts -->
    <script src="WebAssets/assets/nice-WebAssets/assets/WebAssets/assets/jquery-knob/js/jquery.knob.js"></script>
    <script src="WebAssets/assets/nice-WebAssets/assets/js/jquery.sparkline.js" type="text/javascript"></script>
    <script src="WebAssets/assets/nice-WebAssets/assets/WebAssets/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.js"></script>
    <script src="WebAssets/assets/nice-WebAssets/assets/js/owl.carousel.js" ></script>
    <!-- jQuery full calendar -->
    <<script src="WebAssets/assets/nice-WebAssets/assets/js/fullcalendar.min.js"></script> <!-- Full Google Calendar - Calendar -->
	<script src="WebAssets/assets/nice-WebAssets/assets/WebAssets/assets/fullcalendar/fullcalendar/fullcalendar.js"></script>
    <!--script for this page only-->
    <script src="WebAssets/assets/nice-WebAssets/assets/js/calendar-custom.js"></script>
	<script src="WebAssets/assets/nice-WebAssets/assets/js/jquery.rateit.min.js"></script>
    <!-- custom select -->
    <script src="WebAssets/assets/nice-WebAssets/assets/js/jquery.customSelect.min.js" ></script>
	<script src="WebAssets/assets/nice-WebAssets/assets/WebAssets/assets/chart-master/Chart.js"></script>
   
    <!--custome script for all page-->
    <script src="WebAssets/assets/nice-WebAssets/assets/js/scripts.js"></script>
    <!-- custom script for this page-->
    <script src="WebAssets/assets/nice-WebAssets/assets/js/sparkline-chart.js"></script>
    <script src="WebAssets/assets/nice-WebAssets/assets/js/easy-pie-chart.js"></script>
	<script src="WebAssets/assets/nice-WebAssets/assets/js/jquery-jvectormap-1.2.2.min.js"></script>
	<script src="WebAssets/assets/nice-WebAssets/assets/js/jquery-jvectormap-world-mill-en.js"></script>
	<script src="WebAssets/assets/nice-WebAssets/assets/js/xcharts.min.js"></script>
	<script src="WebAssets/assets/nice-WebAssets/assets/js/jquery.autosize.min.js"></script>
	<script src="WebAssets/assets/nice-WebAssets/assets/js/jquery.placeholder.min.js"></script>
	<script src="WebAssets/assets/nice-WebAssets/assets/js/gdp-data.js"></script>	
	<script src="WebAssets/assets/nice-WebAssets/assets/js/morris.min.js"></script>
	<script src="WebAssets/assets/nice-WebAssets/assets/js/sparklines.js"></script>	
	<script src="WebAssets/assets/nice-WebAssets/assets/js/charts.js"></script>
	<script src="WebAssets/assets/nice-WebAssets/assets/js/jquery.slimscroll.min.js"></script>
    <%-- For the editor--%>
    <script type="text/javascript" src="WebAssets/assets/nice-WebAssets/assets/WebAssets/assets/ckeditor/ckeditor.js"></script>
    <!--custom tagsinput-->
    <script src="WebAssets/assets/nice-WebAssets/assets/js/jquery.tagsinput.js"></script>
    <!--custom switch-->
    <script src="WebAssets/assets/nice-WebAssets/assets/js/bootstrap-switch.js"></script>
    <!-- bootstrap-wysiwyg -->
    <script src="WebAssets/assets/nice-WebAssets/assets/js/jquery.hotkeys.js"></script>
    <script src="WebAssets/assets/nice-WebAssets/assets/js/bootstrap-wysiwyg.js"></script>
    <script src="WebAssets/assets/nice-WebAssets/assets/js/bootstrap-wysiwyg-custom.js"></script>
</body>
</html>
